...
namespace Tests\Unit\Slack\Responses;
...
use App\Http\Clients\Slack\Responses\SendMessageResponse;
use Illuminate\Http\Client\Response as ClientResponse;

#[CoversClass(SendMessageResponse::class)]
class SendMessageResponseTest extends TestCase
{
    ...
    {
        $createResponse = SendMessageResponse::fromResponse($this->response);
