...
namespace Tests\Unit\Stripe\Factorys;

use App\Http\Clients\Stripe\Factories\CreateChargeFactory;
...
#[CoversClass(CreateChargeFactory::class)]
class CreateChargeFactoryTest extends TestCase
{
    private CreateChargeFactory $factory;
    ...
    protected function setUp(): void
    {
        ...
        $this->factory = new CreateChargeFactory($this->httpFactory);
    }
